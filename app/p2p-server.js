...
// npm run start
// set HTTP_PORT=3002 && set P2P_PORT=5002 && set PEERS=ws://localhost:5001 && npm run start
// set HTTP_PORT=3003 && set P2P_PORT=5003 && set PEERS=ws://localhost:5002 && npm run start
